...
# 9. **Regresión Logística con penalización L1, L2, o Elastic Net**
class RegresionLogisticaRegularizada:
    ...
    def definir_modelo(self, penalty=['l1','l2','elasticnet'], C=[0.1, 1, 10], solver=['saga'], l1_ratio=[0.1, 0.5, 0.9] ,scoring='roc_auc', cv=None): # sin cv

        '''Crea el modelo'''
        self.rlr_model_model = LogisticRegression()
        print("\nModelo definido!\n")
        ...
        param_grid = {
            ...
            'C': C,  # Costo
            'solver': solver,  # Solver saga para soportar elasticnet
            'l1_ratio': l1_ratio # Sólo para elasticnet
            }
        
        self.grid_search = GridSearchCV(
        estimator=self.rlr_model_model, 
