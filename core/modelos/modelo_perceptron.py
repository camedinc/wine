...
class PerceptronClasificador:
    ...
    def definir_modelo(self, penalty=['l1','l2',None], alpha=[0.0001,0.001,0.01], max_iter=[100], scoring='roc_auc', cv=None): # sin cv
        ...
        '''Define la grilla'''
        param_grid = {
            'penalty':penalty, # Penalidad
            'alpha': alpha, # Alpha
            'max_iter':max_iter # Máximo de iteraciones
            }
        
        self.grid_search = GridSearchCV(
        estimator=self.perceptron_model, 
