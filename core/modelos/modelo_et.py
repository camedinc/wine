...
# 9. **Extra Trees**
class ArbolesExtraClasificador:
    ...
    def definir_modelo(self, n_estimators=[50, 100, 300], max_depth=[None, 5, 10], min_samples_split=[2, 5, 10], scoring='roc_auc', cv=None): # sin cv
        ...
        param_grid = {
            ...
            'min_samples_split': min_samples_split  # Mínima muestra para división
            }
        
        self.grid_search = GridSearchCV(
        estimator=self.et_model, 
